...
The [decimation](https://pepstock-org.github.io/Charba/5.1/org/pepstock/charba/client/configuration/Decimation.html) configuration is nested in the chart configuration as following:
...
| algorithm | [DecimationAlgorithm](https://pepstock-org.github.io/Charba/5.1/org/pepstock/charba/client/enums/DecimationAlgorithm.html) | Decimation algorithm to use.
...
4. The X axis for the dataset must be either a [linear](https://pepstock-org.github.io/Charba/5.1/org/pepstock/charba/client/configuration/CartesianLinearAxis.html) or [time](https://pepstock-org.github.io/Charba/5.1/org/pepstock/charba/client/configuration/CartesianTimeAxis.html) axis.
...
The [filler](https://pepstock-org.github.io/Charba/5.1/org/pepstock/charba/client/configuration/Filler.html) configuration is nested in the chart configuration as following:
...
| drawTime | [DrawTime](https://pepstock-org.github.io/Charba/5.1/org/pepstock/charba/client/enums/DrawTime.html) | Filler draw time. 
