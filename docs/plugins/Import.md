...
:::note PAY ATTENTION
Unfortunately some [Chart.JS](https://www.chartjs.org/docs/3.4.1/developers/plugins.html#plugin-options) plugins implementations are not respecting the described standard way to store the plugin options.
