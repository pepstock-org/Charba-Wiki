...
The implementation is [ChartBackgroundColor](http://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/impl/plugins/ChartBackgroundColor.html) and can be set as following:
...
The ID of plugin is `charbabackgroundcolor` ([ChartBackgroundColor.ID](http://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/impl/plugins/ChartBackgroundColor.html#ID)).
...
In this case you should instantiate a [ChartBackgroundColorOptions](http://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/impl/plugins/ChartBackgroundColorOptions.html) and set it to your chart options as following, setting the color or pattern or gradient you want:
...
If you need to read the plugin options, there is the specific factory, [ChartBackgroundColorOptionsFactory](http://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/impl/plugins/ChartBackgroundColorOptionsFactory.html) as static reference inside the [plugin](http://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/impl/plugins/ChartBackgroundColor.html) which can be used to retrieve the options from the chart as following:
