...
You can also ctahc events with listeners defined for all defined annotations with a single instance, defining it to [AnnotationOptions](https://pepstock-org.github.io/Charba/5.2/org/pepstock/charba/client/annotation/AnnotationOptions.html).
