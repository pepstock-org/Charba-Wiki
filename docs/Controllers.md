...
To create own chart type, you need to perform some specific and mandatory steps:
 ...
 1. create a [controller type](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/controllers/ControllerType.html)
 2. implement the [controller](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/Controller.html) interface where all hooks are defined
 3. extend the [dataset](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/data/Dataset.html) class of the original chart type
 4. extend the [chart](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/IsChart.html) class of the original chart type
...
The controller type constructor is getting a [controller provider](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/controllers/ControllerProvider.html) instance as argument in order to provide the controller during the registration.
...
A controller must implement the [Controller](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/Controller.html) interface which is containing all hooks which will be invoked during the whole chart life cycle.

The interface provides **before** and **after** hooks for each phases exposes by [Chart.JS controller](https://www.chartjs.org/docs/4.0.1/developers/charts.html):

#### Initialization

Every controller is initialized every time new chart instance is creating.

The following hooks (the following ones are the methods definitions in the [Controller](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/Controller.html)) can be used to initialize the chart:
...
The easy way to implement a controller is to extends the [AbstractController](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/controllers/AbstractController.html) class and pass the controller type by the constructor.
