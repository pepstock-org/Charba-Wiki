...
A [gauge chart](https://pepstock-org.github.io/Charba/5.3/org/pepstock/charba/client/impl/charts/GaugeChart.html) is **Charba** extension of **[doughnut chart](ChartDoughnut)**, by a [controller](../Controllers) implementation.
...
The gauge chart allows a number of properties to be specified for the [gauge dataset](https://pepstock-org.github.io/Charba/5.3/org/pepstock/charba/client/impl/charts/GaugeDataset.html). 
...
| thresholds | [Threshold](https://pepstock-org.github.io/Charba/5.3/org/pepstock/charba/client/impl/charts/Threshold.html)[] | [] | The thresholds to apply to the gauge dataset. 
...
The [thresholds](https://pepstock-org.github.io/Charba/5.3/org/pepstock/charba/client/impl/charts/Threshold.html)is the entity which defines the color of the dataset, based on the value of the threshold.
...
**Charba** provides a default threshold implementation by [gauge threshold](https://pepstock-org.github.io/Charba/5.3/org/pepstock/charba/client/impl/charts/DefaultThreshold.html) enumeration.
...
You can reuse the [gauge threshold](https://pepstock-org.github.io/Charba/5.3/org/pepstock/charba/client/impl/charts/DefaultThreshold.html) enumeration, changing color or value or both.
