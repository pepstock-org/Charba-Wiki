...
There 3 main sections:
  ...
  1. **Type** which represents the chart type. See [Type](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/Type.html) and [ChartType](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/ChartType.html) enumeration, with all available chart types out of the box. By controllers, you can create own charts and different types.
  2. **Data** which must be showed by the chart. See [Data](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/data/Data.html) and [the data section](#data) for details.
  3. **Options** which represents a set of options to configure the chart. See [Options](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/configuration/package-summary.html).
  
## Usage 

A **Charba** chart extends always [AbstractChart](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/AbstractChart.html) which wraps a DOM [DIV element](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/dom/elements/Div.html) and implements [IsChart](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/IsChart.html) interface which is passed to callbacks, events handlers, plugins and all other customization items.
...
The [Data](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/data/Data.html) contains the [datasets](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/data/Dataset.html) with data and configuration how data should be showed and the labels for each dataset and data.
...
| :- | :- | :-
| labels | String[] - [Labels](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/data/Labels.html) | The labels to display.
| datasets | [Dataset](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/data/Dataset.html)[] | The datasets of the chart.
