...
The horizontal bar chart allows to define the data and a number of properties, used to display the data, by a [horizontal bar dataset](https://pepstock-org.github.io/Charba/5.4/org/pepstock/charba/client/data/HorizontalBarDataset.html).
...
The horizontal bar chart defines specific [options implementation](https://pepstock-org.github.io/Charba/5.4/org/pepstock/charba/client/configuration/HorizontalBarOptions.html) to be configured. These options are merged with the global chart configuration options to form the options passed to the chart.
