...
| indexAxis | [IndexAxis](http://www.pepstock.org/Charba/3.3/org/pepstock/charba/client/enums/IndexAxis.html) | - | The base axis of the dataset. 'IndexAxis.X' for horizontal bars and 'IndexAxis.Y' for vertical lines.
...
| tension | double | - | Bezier curve tension of the line. Set to 0 to draw straightlines. This option is ignored if monotone cubic interpolation is used.
...
| indexAxis | IndexAxis.X | The base axis of the dataset. 'IndexAxis.X' for horizontal bars and 'IndexAxis.Y' for vertical lines.
...
| pointRadius | _element.getPoint().getRadius()_ | The radius of the point shape. If set to 0, the point is not rendered.
...
| Name | Defaults | Description |
| :- | :- | :-
| backgroundColor | _element.getLine().getBackgroundColorAsString()_ | The fill color/pattern under the line.
| borderCapStyle | _element.getLine().getBorderCapStyle()_ | Cap style of the line. See [MDN](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineCap)
| borderColor | _element.getLine().getBorderColorAsString()_ | The color of the line.
| borderDash | _element.getLine().getBorderDash()_ | Offset for line dashes. See [MDN](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineDashOffset)
| borderDashOffset | _element.getLine().getBorderDashOffset()_ | Offset for line dashes. See [MDN](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineDashOffset)
| borderJoinStyle | _element.getLine().getBorderJoinStyle()_ | Line joint style. See [MDN](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineJoin) 
...
| fill | _element.getLine().getFill()_ | How to fill the area under the line.<br/>See [Filling modes](Colors#filling) specifying the maximum gap length to span. The unit of the value depends on the scale used.
| stepped | _element.getLine().getStepped()_ | If the line is shown as a stepped line.
| tension | _element.getLine().getTension()_ | Bezier curve tension of the line. Set to 0 to draw straightlines. This option is ignored if monotone cubic interpolation is used.
...
| hoverBorderCapStyle | _element.getLine().getBorderCapStyle()_ | The fill color/pattern under the line, when hovered.
| hoverBorderColor | _element.getLine().getBorderColorAsString()_ | The color of the line, when hovered.
| hoverBorderDash | _element.getLine().getBorderDash()_ | Length and spacing of dashes, when hovered. See [MDN](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/setLineDash)
| hoverBorderDashOffset | _element.getLine().getBorderDashOffset()_ | Offset for line dashes, when hovered. See [MDN](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineDashOffset)
| hoverBorderJoinStyle | _element.getLine().getBorderJoinStyle()_ | Line joint style, when hovered. See [MDN](https://developer.mozilla.org/en-US/docs/Web/API/CanvasRenderingContext2D/lineJoin) 
...
| borderDash | [BorderDashCallback](http://www.pepstock.org/Charba/3.3/org/pepstock/charba/client/callbacks/BorderDashCallback.html) | int[]
| borderDashOffset | [BorderDashOffsetCallback](http://www.pepstock.org/Charba/3.3/org/pepstock/charba/client/callbacks/BorderDashOffsetCallback.html) | List&lt;Integer&gt;
