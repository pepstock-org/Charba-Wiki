...
The treemap chart allows to define the data and a number of properties, used to display the data, by a [matrix dataset](https://pepstock-org.github.io/Charba/4.2/org/pepstock/charba/client/matrix/MatrixDataset.html).
...
| borderRadius | int - [BarBorderRadius](https://pepstock-org.github.io/Charba/4.2/org/pepstock/charba/client/data/BarBorderRadius.html) | [Yes](#scriptable) | The border radius (in pixels) of matrix element.
