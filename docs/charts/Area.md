...
The area chart allows to define the data and a number of properties, used to display the data, by a [area dataset](https://pepstock-org.github.io/Charba/6.4/org/pepstock/charba/client/data/AreaDataset.html).
