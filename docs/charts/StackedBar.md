...
The stacked bar chart allows a number of properties to be specified for each [stacked bar dataset](https://pepstock-org.github.io/Charba/6.2/org/pepstock/charba/client/data/StackedBarDataset.html). These are used to set display properties for a specific dataset.
...
The stacked bar chart specific [options implementation](https://pepstock-org.github.io/Charba/6.2/org/pepstock/charba/client/configuration/StackedBarOptions.html) to be configured. These options are merged with the global chart configuration options to form the options passed to the chart.
...
The stacked horizontal bar allows a number of properties to be specified for each [stacked horizontal bar dataset](https://pepstock-org.github.io/Charba/6.2/org/pepstock/charba/client/data/StackedHorizontalBarDataset.html). These are used to set display properties for a specific dataset.
