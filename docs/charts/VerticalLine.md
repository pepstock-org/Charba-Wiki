...
The vertical line chart allows to define the data and a number of properties, used to display the data, by a [vertical line dataset](https://pepstock-org.github.io/Charba/5.4/org/pepstock/charba/client/data/VerticalLineDataset.html).
