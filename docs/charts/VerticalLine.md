...
The vertical line chart allows to define the data and a number of properties, used to display the data, by a [vertical line dataset](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/data/VerticalLineDataset.html).
