...
The choropleth chart allows to define the data and a number of properties, used to display the data, by a [choropleth dataset](https://pepstock-org.github.io/Charba/4.0/org/pepstock/charba/client/geo/ChoroplethDataset.html).
...
The style of the dataset can be configured by [choropleth bar](https://pepstock-org.github.io/Charba/4.0/org/pepstock/charba/client/geo/ChoroplethBar.html), which extends a [Bar](../../configuration/Elements#bar) elements, as following:
...
Choropleth dataset needs to contain a data array of points, each data point has to contain the [Feature](https://pepstock-org.github.io/Charba/4.0/org/pepstock/charba/client/geo/Feature.html) to render and containing the value for the coloring.

Choropleth data points are mapped by [ChoroplethDataPoint](https://pepstock-org.github.io/Charba/4.0/org/pepstock/charba/client/geo/ChoroplethDataPoint.html).
...
The choropleth chart defines specific [options implementation](https://pepstock-org.github.io/Charba/4.0/org/pepstock/charba/client/geo/ChoroplethOptions.html) to be configured.
...
| Name | Type | Default | Description
| :- | :- | :- | :-
| interpolate | [Interpolate](https://pepstock-org.github.io/Charba/4.0/org/pepstock/charba/client/geo/enums/Interpolate.html) | Interpolate.BLUES | The color interpolation of the scale.
| missingColor | String - [IsColor](https://pepstock-org.github.io/Charba/4.0/org/pepstock/charba/client/colors/IsColor.html) | HtmlColor.TRANSPARENT | The color to use the data is missing.
...
The interpolate property can be set as [scriptable option](https://pepstock-org.github.io/Charba/4.0/org/pepstock/charba/client/geo/callbacks/InterpolateCallback.html), as following:
