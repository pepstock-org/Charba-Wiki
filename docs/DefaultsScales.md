...
The [display formats](http://www.pepstock.org/Charba/3.3/org/pepstock/charba/client/options/DisplayFormats.html) configuration is nested into the scale configuration as following: 
