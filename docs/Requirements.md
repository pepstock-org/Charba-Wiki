...
To enable the minifying of javascript objects, not provided out-of-the-box, **Charba** needs also [Google Closure Compiler](https://developers.google.com/closure/compiler/), invoked only in [Ant build.xml](https://github.com/pepstock-org/Charba/blob/5.5/build.xml).
...
| Google Closure Compiler | v20220719 | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0)
...
| Chart Geo | [3.9.0](https://github.com/sgratzl/chartjs-chart-geo/releases/tag/v3.9.0) | [MIT](https://github.com/sgratzl/chartjs-chart-geo/blob/main/LICENSE)
...
| :- | :- | :- | :- | :- | :- | :- | :- | :- | :-
| 5.6 | 2.1.0 | 1.1.0 | 1.2.1 | 2.0.8 | 2.0.1 | 0.5.1 | 3.9.0 | 2.0.2 | 1.1.1 | 0.9.0
