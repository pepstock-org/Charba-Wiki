...
To enable the minifying of javascript objects, not provided out-of-the-box, **Charba** needs also [Google Closure Compiler](https://developers.google.com/closure/compiler/), invoked only in [Ant build.xml](https://github.com/pepstock-org/Charba/blob/6.0/build.xml).
...
| Google Closure Compiler | v20221102 | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0)
| Chart.JS | [4.0.1](https://github.com/chartjs/Chart.js/releases/tag/v4.0.1) | [MIT](https://raw.githubusercontent.com/chartjs/Chart.js/v4.0.1/LICENSE.md)
...
| Luxon | [3.1.1](https://github.com/moment/luxon/releases/tag/3.1.1) | [MIT](https://raw.githubusercontent.com/moment/luxon/master/license.md)
...
| Annotation | [2.1.0](https://github.com/chartjs/chartjs-plugin-annotation/releases/tag/v2.1.0) | [MIT](https://github.com/chartjs/chartjs-plugin-annotation/blob/master/LICENSE.md)
| Gradient | [0.5.1](https://github.com/kurkle/chartjs-plugin-gradient/releases/tag/v0.5.1) | [MIT](https://github.com/kurkle/chartjs-plugin-gradient/blob/master/LICENSE)
| Chart Geo | [3.10.0](https://github.com/sgratzl/chartjs-chart-geo/releases/tag/v3.10.0) | [MIT](https://github.com/sgratzl/chartjs-chart-geo/blob/main/LICENSE)
| Chart Treemap | [2.1.3](https://github.com/kurkle/chartjs-chart-treemap/releases/tag/v2.1.3) | [MIT](https://github.com/kurkle/chartjs-chart-treemap/blob/next/LICENSE)
| Chart Matrix | [1.3.0](https://github.com/kurkle/chartjs-chart-matrix/releases/tag/v1.3.0) | [MIT](https://github.com/kurkle/chartjs-chart-matrix/blob/next/LICENSE)
...
| :- | :- | - | - | - | - | - 
| 6.0 | 11 | - | 2.0.0 | 2.9.0 | v20221102 | -
| 5.8 | 11 | - | 2.0.0 | 2.9.0 | v20221102 | -
| 5.7 | 11 | - | 2.0.0 | 2.9.0 | v20221004 | -
| 5.6 | 11 | - | 2.0.0 | 2.9.0 | v20220905 | -
| 5.5 | 11 | - | 2.0.0 | 2.9.0 | v20220719 | -
...
| :- | :- | :- | :- | :- | :- | :- | :- | :- | :-
| 6.0 | 2.1.0 | 1.1.0 | 2.0.0 | 2.0.8 | 2.1.0 | 0.5.1 | 3.10.0 | 2.1.3 | 1.3.0 | 0.12.0
