...
To enable the minifying of javascript objects, not provided out-of-the-box, **Charba** needs also [Google Closure Compiler](https://developers.google.com/closure/compiler/), invoked only in [Ant build.xml](https://github.com/pepstock-org/Charba/blob/6.2/build.xml).
...
| Google Closure Compiler | v20230206 | [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0)
| Chart.JS | [4.2.1](https://github.com/chartjs/Chart.js/releases/tag/v4.2.1) | [MIT](https://raw.githubusercontent.com/chartjs/Chart.js/v4.2.1/LICENSE.md)
...
<img src={useBaseUrl('/img/charba_jar_trend_62.png')} />
