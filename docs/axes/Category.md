...
The [category axis](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/configuration/CartesianCategoryAxis.html) will draw the labels from one of the label arrays included in the chart data.
...
| labels | [Labels](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/data/Labels.html) | The labels to display.
...
The category axis provides the following options for configuring [tick marks](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/configuration/CartesianCategoryTick.html).
...
| font | [Font](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/options/Font.html) | [Yes](#scriptable) | Font of ticks.
...
To apply a custom callback, you can set a [CategoryTickCallback](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/callbacks/CategoryTickCallback.html) instance to the axis options, as following:
