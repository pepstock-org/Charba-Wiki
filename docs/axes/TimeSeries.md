...
The [time series axis](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/configuration/CartesianTimeSeriesAxis.html) is used to display times and dates. When building its [ticks](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/configuration/CartesianTimeTick.html), it will automatically calculate the most comfortable unit base on the size of the scale.
...
To use time series axis, you must use [DataPoint](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/data/DataPoint.html) in order to set the date object in the axis. 
...
| bounds | [Bounds](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/enums/Bounds.html) | Determines the scale bounds on time axis. 
...
The time series axis provides a [Time](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/configuration/Time.html) object to configure how times must be managed on axis. It provides the **set** and **get** methods as following:
...
The time series axis provides the following options for configuring [tick marks](https://www.pepstock.org/Charba/4.0/org/pepstock/charba/client/configuration/CartesianTimeTick.html).
