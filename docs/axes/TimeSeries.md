...
To use time series axis, you must use [DataPoint](https://pepstock-org.github.io/Charba/6.5/org/pepstock/charba/client/data/DataPoint.html) in order to set the date object in the axis. 
