...
The logarithmic axis provides the following options for configuring [tick marks](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/configuration/CartesianLogarithmicTick.html).
