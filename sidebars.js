module.exports = {
  docs: [
    ...
    },
    {
      ...
      collapsed: true,
      items: ['configuration/Commons', 'configuration/Interaction', 'configuration/Animation', 'configuration/Datasets', 'configuration/Legend', 'configuration/Tooltip', 'configuration/Title', 'configuration/Elements', 'configuration/Layout', 'configuration/FillerAndDecimation',
    ...
    },
    {
      ...
      'charts/ChartStackedBar', 'charts/ChartTimeSeries',  { "Geographic map": ['charts/geo/Geo', 'charts/geo/ChartChoropleth', 'charts/geo/ChartBubbleMap']}, 'charts/ChartMeter', 'charts/ChartGauge', 'charts/Api'],
    },
    {
      type: 'category',
      label: 'Using axes',
    ...
    {
      "type": "link",
      "href": "https://github.com/pepstock-org/Charba/releases/tag/4.0",
      "label": "Release note"
    },
    {
      "type": "link",
      "href": "https://pepstock-org.github.io/Charba/4.0/index.html",
      "label": "Javadoc API"
    }
],
};