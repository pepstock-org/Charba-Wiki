...
The bubble map chart allows to define the data and a number of properties, used to display the data, by a [bubble map dataset](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/BubbleMapDataset.html).
...
The style for the geografical configuration of the dataset can be configured by [`geoFeature` element](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/GeoFeature.html), as following:
...
Bubble map data points are mapped by [ChoroplethDataPoint](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/BubbleMapDataPoint.html).
...
The bubble map chart defines specific [options implementation](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/BubbleMapOptions.html) to be configured.
...
| Name | Type | Default | Description
| :- | :- | :- | :-
| clipMap | boolean - [ClipMap](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/enums/ClipMap.html)| ClipMap.OUTLINE_GRATICULE | Whether to clip the rendering to the chart area of the graph or to another area.
 ...
 * [Size axis](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/SizeAxis.html) which extends the [cartesian linear axis](../../axes/CartesianLinearAxes) to repesent numbers.
 * [Size logarithmic axis](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/SizeLogarithmicAxis.html) which extends the [cartesian logarithmic axis](../../axes/CartesianLogarithmicAxes) to represent number by logarithmic base. 
...
| :- | :- | :- | :- | :-
| mode | [Mode](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/enums/Mode.html) | Mode.AREA | [Yes](#scriptable) | The operation modes for the scale, area means that the area is linearly increasing whereas radius the radius is.
...
| :- | :- | :- 
| mode | [ModeCallback](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/callbacks/ModeCallback.html) | [Mode](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/enums/Mode.html) 
| missingRadius | [RadiusCallback](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/callbacks/RadiusCallback.html)&lt;ScaleContext&gt; | double
| range | [RangeCallback](https://pepstock-org.github.io/Charba/6.3/org/pepstock/charba/client/geo/callbacks/RangeCallback.html) | List&lt;Integer&gt;
