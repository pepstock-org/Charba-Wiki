...
You can pass the HTML as string or by an [element](https://pepstock-org.github.io/Charba/5.6/org/pepstock/charba/client/dom/BaseHtmlElement.html). If you use a string, the string must be XML well-formed, following the [xHTML specification](http://www.w3.org/1999/xhtml) otherwise an exception will occurs.
