...
[Radial axes](https://pepstock-org.github.io/Charba/5.0/org/pepstock/charba/client/configuration/RadialAxis.html) are used specifically for the radar and polar area chart types. These axes overlay the chart area, rather than being positioned on one of the edges. 
...
The [radial axis](https://pepstock-org.github.io/Charba/5.0/org/pepstock/charba/client/configuration/RadialAxis.html) is use to chart numerical data.
...
The axis has configuration properties for [ticks](https://pepstock-org.github.io/Charba/5.0/org/pepstock/charba/client/configuration/RadialLinearTick.html), [angle lines](AngleLines) (line that appear in a radar chart outward from the center), [point labels](PointLabels) (labels around the edge in a radar chart):
...
The radial linear axis provides the following options for configuring [tick marks](https://pepstock-org.github.io/Charba/5.0/org/pepstock/charba/client/configuration/RadialLinearTick.html).
...
| count | [CountCallback](https://pepstock-org.github.io/Charba/5.0/org/pepstock/charba/client/callbacks/CountCallback.html) | int
...
| maxTicksLimit | [MaxTicksLimitCallback](https://pepstock-org.github.io/Charba/5.0/org/pepstock/charba/client/callbacks/MaxTicksLimitCallback.html) | int
...
| precision | [PrecisionCallback](https://pepstock-org.github.io/Charba/5.0/org/pepstock/charba/client/callbacks/PrecisionCallback.html) | int
...
| stepSize | [StepSizeCallback](https://pepstock-org.github.io/Charba/5.0/org/pepstock/charba/client/callbacks/StepSizeCallback.html) | double
