 ...
 * Callbacks
    ...
    * Datalabels listeners callback to select the labels, leveraging on [DatasetSelectionEventHandler](https://pepstock-org.github.io/Charba/5.0/org/pepstock/charba/client/events/DatasetSelectionEventHandler.html) 
