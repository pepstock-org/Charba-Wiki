...
The plugin ID is a constant everywhere available, `LabelsPlugin.ID`, in [LabelsPlugin](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/LabelsPlugin.html) entry point.
...
The configuration [LabelsOptions](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/LabelsOptions.html) class is the entry point of plugin configuration. 

Every [label](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/Label.html) configuration can be add to the [LabelsOptions](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/LabelsOptions.html), assigning a unique id.

The id of a label configuration can be set by a string or by a specific class, [LabelId](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/LabelId.html).
...
The following options can configure how the labels will look like and they can be applied to the [label](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/Label.html) object.
...
| color | String - [IsColor](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/colors/IsColor.html) | [default color](../defaults/DefaultsCharts) | [Yes](#color) | The font color of the label.
| font | [Font](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/Font.html) | [default font](../defaults/DefaultsCharts#font) | [Yes](#font) | The font of label text.
| images | [Img](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/dom/elements/Img.html)[] | `null` | - | Set images when the rendering is set to Render.IMAGE.
...
| position | [Position](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/enums/Position.html) | Position.DEFAULT | - | Position to draw label. Bar chart ignores this.
| precision | int | 0 | - | Precision for percentage label text.
| render | [Render](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/enums/Render.html) | Render.PERCENTAGE | [Yes](#render) | The value of the label to render.
...
| shadowColor | String - [IsColor](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/colors/IsColor.html) | rgba(0,0,0,0.3) - <span style={{backgroundColor: 'rgba(0,0,0,0.3)', border: '1px solid'}}>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span> | - | The label text shadow color.
...
The callbacks are getting the only 1 argument, the [plugin context](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/LabelsContext.html) which contains the context of the callback execution.
...
| dataItem | [DataItem](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/items/DataItem.html) | The value of the label.
...
| labelOptions | [Label](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/Label.html) | The label configuration where the options is defined as scriptable.
...
| type | [ContextType](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/items/ContextType.html) | The type of the context. It can be ONLY `ContextType.LABELS`.
...
| render | [RenderCallback](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/callbacks/RenderCallback.html) | String
...
The color property can be set as [scriptable option](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/callbacks/ColorCallback.html), as following:
...
The font property can be set as [scriptable option](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/callbacks/FontCallback.html), providing a [font item](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/items/FontItem.html) instance, as following:
...
The render property can be set as [scriptable option](https://pepstock-org.github.io/Charba/6.0/org/pepstock/charba/client/labels/callbacks/RenderCallback.html), as following:
